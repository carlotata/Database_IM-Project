...
<body class="h-screen bg-cover bg-no-repeat flex items-center justify-center font-[Roboto]" style="background-image: url('pic/cpc.jpg'); background-position: center calc(100% + 316px);">
    ...
    <script>
        const form = document.getElementById('signupFormActual');
